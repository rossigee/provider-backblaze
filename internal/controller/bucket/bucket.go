...
func SetupBucket(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1.BucketGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1.BucketGroupVersionKind),
...
// SetupBucketV1Beta1 adds a controller that reconciles v1beta1 Bucket managed resources (namespaced).
func SetupBucketV1Beta1(mgr ctrl.Manager, o controller.Options) error {
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	return managed.ExternalCreation{
		// Optionally return any details that should be passed to Connect.
		// These will be stored as the connection secret.
