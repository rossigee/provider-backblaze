...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	err = c.writeSecretForKey(ctx, cr, key)
	if err != nil {
...
// writeSecretForKey writes the application key to the specified secret
func (c *external) writeSecretForKey(ctx context.Context, cr *v1.User, key *clients.B2CreateKeyResponse) error {
